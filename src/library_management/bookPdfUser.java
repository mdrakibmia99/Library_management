 ...
 * @author rkrakib
 */
public class bookPdfUser extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bookPdfUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
